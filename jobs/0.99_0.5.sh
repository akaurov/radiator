#!/bin/bash
#SBATCH --job-name=radiator0.99_0.5
#SBATCH --output=/home/kaurov/scratch-midway/radiator/jobs/radiator0.99_0.5.out
#SBATCH --error=/home/kaurov/scratch-midway/radiator/jobs/radiator0.99_0.5.err
